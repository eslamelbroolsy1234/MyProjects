...
const string ClientsFileName = "D:\\NewVS\\Course8_AboHadhood\\Bank3_Extension2\\Clients.txt.txt";
const string UsersFileName = "D:\\NewVS\\Course8_AboHadhood\\Bank3_Extension2\\Users.txt";

enum enTransactionsMenueOptions { eDeposit = 1, eWithdraw = 2, eShowTotalBalance = 3, eShowMainMenue = 4 };

enum enMainMenueOptions { eListClients = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClient = 4, eFindClient = 5, eShowTransactionsMenue = 6, eManageUser = 7, eExit = 8 };

enum eManageUsers { eListUser = 1, eAddNewUser = 2, eDeleteUser = 3, eUpdateUser = 4, eFindUser = 5, eMainMenue = 6 };
...
vector <stUser> LoadUsersDataFromFile(string UserFileNamew)
{

    vector <stUser> vUser;

    fstream MyFile;
    MyFile.open(UserFileNamew, ios::in);//read Mode
...
bool FindClientByUsername(string Username, vector <stUser> vUsers, stUser& User)
{
...
void PerfromManageUsersMenueOption(eManageUsers ManageUsers)
{
    switch (ManageUsers)
    {
    case eManageUsers::eListUser:
    {
        system("cls");
        ShowListUsersScreen();
        GoBackToManagerUser();
...
void ShowManagerUserScreen()
{
    ...
    cout << "\t[6] Main Menue.\n";
    cout << "===========================================\n";
    PerfromManageUsersMenueOption((eManageUsers)ReadManageUsersMenueOption());
...
bool IsLoginFaild(string Username, string Password)
{
...
void Login()
{
    ...
    do
    {
        ...
        FirstExist = !IsLoginFaild(UserName, Password);
